...
interface IQueryBuilder {
	 ...
	 * @since 8.2.0
	 */
	public function getParameterType(int|string $key): mixed;
	 ...
	 */
	public function selectAlias(string|IParameter|IQueryFunction $select, string $alias): self;
	 ...
	 * @psalm-taint-sink sql $value
	 */
	public function setValue(string $column, IParameter|IQueryFunction|string $value): self;
	 ...
	 * </code>
	 *
	 * @param array<string, IParameter|IFunctionBuilder|string|int> $values The values to specify for the insert query indexed by column names.
	 *
	 * @since 8.2.0
	 *
